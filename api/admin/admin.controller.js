...
module.exports = {
        ...
        if (!err) {
          getUserByUserEmail(body.email, (err, results) => {
            ...
            var mailOptions = {
              ...
              <a href=" http://${req.headers.host}/admin9/${results.email}/verify/${results.token}" >click this link to verify Email </a>
              `,
            };
  ...
  mailPasswordreset: (req, res) => {
    ...
    getUserByUserEmail(body.email, (err, results) => {
      ...
      <a href=" http://${req.headers.host}/admin8/${body.email}/verify/${signedToken}" > click this link to verify Email </a>
